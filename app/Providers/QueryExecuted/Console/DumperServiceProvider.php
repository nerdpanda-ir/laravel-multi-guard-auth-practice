...
class DumperServiceProvider extends ServiceProvider implements DeferrableProvider
{
    ...
    public function __construct($app)
    {
        ...
        $this->contract = config(
            'queryExecuted.Console.DumperService.contract'
        );
        $this->alias = config('queryExecuted.Console.DumperService.alias');
        $this->service = config(
            'queryExecuted.Console.DumperService.service'
        );
        $this->isSingleton = config(
            'queryExecuted.Console.DumperService.isSingleton'
        );
    }
